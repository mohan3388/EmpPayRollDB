...
insert into EmpPayRoll values('pooja',23000,'2019.APR.22')
...
select Salary from EmpPayRoll where Name='govind';
...
Alter table EmpPayRoll Add  bigint, Address varchar(50), Department varchar(30);
